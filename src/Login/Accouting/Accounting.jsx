...
import "../Accouting/Accounting.css"
...
<div className="login-wrap">
  <div className="login-html">
    <input  id="tab-1" type="radio" name="tab1" className="sign-in" defaultChecked /><label htmlFor="tab-1" className="tab1">Sign In</label>
    <input id="tab-2" type="radio" name="tab1" className="sign-up" /><label  htmlFor="tab-2" className="tab1">Sign Up</label>
